...
- (void)setupUI{
   ...
   [self.view addSubview:headerView];
    ...
    cicleView.frame = CGRectMake(150, 20, 48, 48);
    // 添加一个电话lebel
    ...
    lb_tellphoneNum.frame = CGRectMake(120, 80, 140, 20);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:mainFirstCell];
...
//    AFBMineTableViewCell *cell= [tableView dequeueReusableCellWithIdentifier:mainFirstCell forIndexPath:indexPath];
    ...
    if (indexPath.section == 0 && indexPath.row == 0)
    {
        ...
        cell.imageView.image = [UIImage imageNamed:@"v2_my_address_icon@3x.png"];
    }
    else if (indexPath.section == 0 && indexPath.row == 1)
    {
    
        cell.textLabel.text = @"我的店铺";
        cell.imageView.image = [UIImage imageNamed:@"v2_store_empty@2x.png"];
    }
